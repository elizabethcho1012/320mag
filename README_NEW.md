...
[SUPABASE_MIGRATIONS_GUIDE.md](SUPABASE_MIGRATIONS_GUIDE.md) 참고

Supabase Dashboard (https://supabase.com/dashboard/project/qitdjfckazpkqhhlacyx)에서:
1. SQL Editor 열기
